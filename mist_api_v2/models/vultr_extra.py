...
class VultrExtra(Model):
    ...
    def __init__(self, backups=None, ddos_protection=None):  # noqa: E501
        ...
        :type ddos_protection: AnyType
        """
        self.openapi_types = {
            'backups': bool,
            'ddos_protection': AnyType
        }
    ...
    def backups(self):
        ...
        Enable automatic backups for the instance, invalid for \"Bare Metal\" & \"Dedicated Cloud\" size types. There is an additional charge depending on the size selected  # noqa: E501
