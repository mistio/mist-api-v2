...
class ListUsersResponse(Model):
    ...
    def __init__(self, data=None, meta=None):  # noqa: E501
        ...
        :type data: List[User]
        :param meta: The meta of this ListUsersResponse.  # noqa: E501
    ...
    @property
    def data(self):
        """Gets the data of this ListUsersResponse.


        :return: The data of this ListUsersResponse.
        :rtype: List[User]
        """
        return self._data
    ...
    def data(self, data):
        ...
        :param data: The data of this ListUsersResponse.
        :type data: List[User]
        """
    ...
    @property
    def meta(self):
        """Gets the meta of this ListUsersResponse.


        :return: The meta of this ListUsersResponse.
    ...
    @meta.setter
    def meta(self, meta):
        """Sets the meta of this ListUsersResponse.


        :param meta: The meta of this ListUsersResponse.
        :type meta: ResponseMetadata
        """
