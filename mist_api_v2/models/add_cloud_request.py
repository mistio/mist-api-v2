...
class AddCloudRequest(Model):
    ...
    def provider(self, provider):
        ...
        :type provider: str
        """
        allowed_values = ["alibaba", "amazon", "azure", "cloudsigma", "digitalocean", "equinix", "google", "ibm", "kvm", "kubevirt", "kubernetes", "linode", "lxd", "maxihost", "onapp", "openstack", "openshift", "other", "rackspace", "vcloud", "vexxhost", "vsphere", "vultr"]  # noqa: E501
