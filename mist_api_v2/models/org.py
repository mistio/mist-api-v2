...
class Org(Model):
    ...
    def __init__(self, id=None, name=None, clouds_count=None, total_machine_count=None, created=None, enterprise_plan=None, selected_plan=None, default_monitoring_method=None, enable_r12ns=None, insights_enabled=None, ownership_enabled=None):  # noqa: E501
