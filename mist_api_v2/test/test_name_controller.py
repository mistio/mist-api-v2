...
resource_name = 'NameController'.replace('Controller', '').lower()
try:
...
for key in vars(TestNameController):
    ...
    if callable(attr) and any(k in key for k in DELETE_KEYWORDS):
        setattr(TestNameController, key, pytest.mark.order('last')(attr))
...
if SETUP_MODULE_EXISTS:
    ...
    TestNameController = pytest.mark.usefixtures('setup')(
        TestNameController)
