...
resource_name = 'TotalMachineCountController'.replace('Controller', '').lower()
try:
...
for key in vars(TestTotalMachineCountController):
    ...
    if callable(attr) and any(k in key for k in DELETE_KEYWORDS):
        setattr(TestTotalMachineCountController, key, pytest.mark.order('last')(attr))
...
if SETUP_MODULE_EXISTS:
    ...
    TestTotalMachineCountController = pytest.mark.usefixtures('setup')(
        TestTotalMachineCountController)
